...
static void __set_device_powered(struct telephony_modem *modem,
					bool powered);
static int __check_device_powered(const char *path, bool online);
...
static bool __set_network_ipconfig(struct telephony_network *network,
...
static int __check_device_powered(const char *path, bool powered)
{
